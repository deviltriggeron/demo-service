...
import (
	...
	cfg "demo-service/internal/config"
	kafka "demo-service/internal/kafka"
	db "demo-service/internal/postgres"
	router "demo-service/internal/router"
...
func main() {
	...
	httpSrv := router.NewServer(svc)

	wg.Add(2)
	go func() {
		defer wg.Done()
		kafka.ConsumeOrder(ctx, "orders", svc)
	}()
